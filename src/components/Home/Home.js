                    ...
                    <div className = "row">
                        <div className = "col-md-6 aboutMe">
                            <h5 className="card-title animate__animated animate__lightSpeedInLeft">A little about me...</h5>
                                <p className="card-text animate__animated animate__lightSpeedInLeft"/>I am a stay-at-home mom currently enrolled in a bootcamp at the University of Washington.
